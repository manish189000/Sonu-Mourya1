...
const videos = [
  ...
  },
  {
    ...
    description: "Rain and Destruction 1",
  },
  {
    src: video4,
    title: " The Fall of the House of Usher",
    description: "Rain and Destruction 2",
  },
  {
    src: video5,
    title: "Personal",
...
const VFXHero1 = () => {
  ...
  return (
    ...
    Not for Public use
        ...
        {/* <div className="absolute inset-0 bg-black bg-opacity-50 flex flex-col items-start justify-end  pb-7 pl-20 ">
        ...
        <div className="absolute inset-0 bg-black bg-opacity-50 flex flex-col items-center justify-end pb-7 pl-20 md:items-start">
          <h1 className="text-3xl md:text-4xl lg:text-6xl font-Arial text-[#CA8A04] font-bold mb-4 text-center md:text-left">
            {videos[currentIndex].title}
          </h1>
          <p className="text-lg md:text-base lg:text-2xl mb-8 text-center md:text-left">
            {videos[currentIndex].description}
          </p>
        </div>
      </div>
