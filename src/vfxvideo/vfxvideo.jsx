...
// import poster4 from "../assets/raone.jpg";
// import poster3 from "../assets/thefall1.png";
// import poster5 from "../assets/nagin.jpg";
// import poster2 from "../assets/WEDNESDAY.jpg";
// import poster6 from "../assets/dino1.jpg";

// const posterData = [
//   { id: 1, title: "THE PORTER SHOW", src: poster1 },
//   { id: 2, title: "WEDNESDAY", src: poster2 },
//   { id: 3, title: "THE FALL OF THE HOUSE OF USHER", src: poster3 },
//   { id: 4, title: "RAONE", src: poster4 },
//   { id: 5, title: "NAGIN", src: poster5 },
//   { id: 6, title: "DINO RANCH SHOW", src: poster6 },
// ];

// const Vfx = () => {
//   return (
//     <div className="container w-full bg-black mx-auto pb-12">
//       <h2 className="text-4xl pt-36 font-bold mb-8 text-center text-[#CA8A04]">
//         VFX Poster Gallery
//       </h2>
//       <div className="mx-auto bg-black max-w-3xl mb-6 text-center">
...
//           poster represents a unique project, demonstrating my skills in
//           creating realistic and captivating visual effects. Enjoy exploring!
//         </p>
//       </div>
...
const Vfx = () => {
  return (
    <div className="w-full bg-black pb-12 sm:pb-16 md:pb-20 lg:pb-24">
      <h2 className="text-4xl pt-36 font-bold mb-8 text-center text-[#CA8A04]">
        VFX Poster Gallery
      </h2>
      <div className="mx-auto bg-black max-w-3xl mb-6 text-center">
